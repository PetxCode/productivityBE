...
exports.deleteOneUser = exports.updateOneUser = exports.readOneUser = exports.readUsers = exports.signUser = exports.createUser = void 0;
...
const updateOneUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(404).json({
            message: "Error Updating one Users",
        });
    }
});
...
const deleteOneUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(404).json({
            message: "Error deleting one Users",
        });
    }
});
